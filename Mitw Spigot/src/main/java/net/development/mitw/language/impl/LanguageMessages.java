...
public class LanguageMessages {
	...
	public String zh_tw_muted = ChatColor.RED + "&c請不要嘗試發送的同樣訊息";
	public String en_us_muted = ChatColor.RED + "please don't repeat the same message";

	public String zh_tw_noSpam = ChatColor.RED + "&c請不要說難聽的話,謝謝你";
	public String en_us_noSpam = ChatColor.RED + "Do Not toxic, thank you";
